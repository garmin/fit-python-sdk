...
class SessionMesg(FitMesg, total=False):
    ...
    avg_paddlesport_cadence: int
    # average pushes per minute in a session
    avg_push_cadence: int
    max_cadence: int
    max_running_cadence: int
    max_swimming_cadence: int
    max_paddlesport_cadence: int
    # max pushes per minute in a session
    max_push_cadence: int
...
class LapMesg(FitMesg, total=False):
    ...
    total_strides: int
    total_strokes: int
    # total number of pushes in a lap
    total_pushes: int
    total_calories: int
    # If New Leaf
    total_fat_calories: int
    ...
    avg_swimming_cadence: int
    avg_paddlesport_cadence: int
    # average pushes per minute in a lap
    avg_push_cadence: int
    max_cadence: int
    max_running_cadence: int
    max_swimming_cadence: int
    max_paddlesport_cadence: int
    # max pushes per minute in a lap
    max_push_cadence: int
    # total_power / total_timer_time if non_zero_avg_power otherwise total_power / total_elapsed_time
    avg_power: int
    max_power: int
...
class BatteryMesg(FitMesg, total=False):
    timestamp: Union[int, datetime]
    capacity: int
...
class BarometerDataMesg(FitMesg, total=False):
    ...
    enhanced_altitude: Union[float, List[Optional[float]]]
...
class SplitMesg(FitMesg, total=False):
    ...
    avg_paddlesport_cadence: float
    # average pushes per minute in a split
    avg_push_cadence: int
    max_cadence: float
    max_running_cadence: float
    max_swimming_cadence: float
    max_paddlesport_cadence: float
    # max pushes per minute in a split
    max_push_cadence: int
    total_cycles: int
    total_strides: int
    total_strokes: int
    # total reps in a split round
    total_reps: int
    # total number of pushes in a split
    total_pushes: int
    avg_temperature: int
    max_temperature: int
    min_temperature: int
    ...
    # This is only set for split types that will trigger the end of a lap when the split ends
    num_laps: int
    climb_grading_scale: ClimbGradingScale
    climb_grade_value: int
    climb_grade_yds: YdsGradingScale
    climb_grade_uiaa: UiaaGradingScale
    climb_grade_french: FrenchGradingScale
    climb_grade_british_adjectival: BritishAdjectivalGradingScale
    climb_grade_british_technical: BritishTechnicalGradingScale
    climb_grade_ewbank: EwbankGradingScale
    climb_grade_brazilian: BrazilianGradingScale
    climb_grade_saxon: SaxonGradingScale
    climb_grade_vermin: VerminGradingScale
    climb_grade_font: FontGradingScale
    climb_grade_dankyu: DankyuGradingScale
    ...
    max_grade: float
    min_cadence: float
    min_running_cadence: float
    min_swimming_cadence: float
    min_paddlesport_cadence: float
    # min pushes per minute in a split
    min_push_cadence: int
    avg_grade_adjusted_speed: float
    avg_stress: int
    avg_vam: float
    jump_count: int
    total_moving_time: float
    dive_section_type: DiveSectionType
    avg_ascent_rate: float
    max_ascent_rate: float
    avg_descent_rate: float
    max_descent_rate: float
    total_ascent_time: float
    total_descent_time: float
    total_hang_time: float
    apnea_discipline: ApneaDiscipline
    # Average depth. 0 if above water
    avg_depth: float
    # Max depth. 0 if above water
    max_depth: float
    min_heart_rate: int
    # Time since end of last dive
    surface_interval: int
...
class SplitSummaryMesg(FitMesg, total=False):
    ...
    avg_swimming_cadence: float
    avg_paddlesport_cadence: float
    # average pushes per minute in all splits of the type
    avg_push_cadence: int
    max_cadence: float
    max_running_cadence: float
    max_swimming_cadence: float
    max_paddlesport_cadence: float
    # max pushes per minute in all splits of the type
    max_push_cadence: int
    total_cycles: int
    total_strides: int
    total_strokes: int
    # total reps in all splits
    total_reps: int
    # total number of pushes in all splits of the type
    total_pushes: int
    avg_temperature: int
    max_temperature: int
    min_temperature: int
    ...
    max_ascent: int
    climb_grading_scale: ClimbGradingScale
    climb_max_grade_value: int
    climb_max_grade_yds: YdsGradingScale
    climb_max_grade_uiaa: UiaaGradingScale
    climb_max_grade_french: FrenchGradingScale
    climb_max_grade_british_adjectival: BritishAdjectivalGradingScale
    climb_max_grade_british_technical: BritishTechnicalGradingScale
    climb_max_grade_ewbank: EwbankGradingScale
    climb_max_grade_brazilian: BrazilianGradingScale
    climb_max_grade_saxon: SaxonGradingScale
    climb_max_grade_vermin: VerminGradingScale
    climb_max_grade_font: FontGradingScale
    climb_max_grade_dankyu: DankyuGradingScale
    num_falls: int
    num_climbs_attempted: int
    num_climbs_completed: int
    # Distance of the longest split
    max_distance: float
    metabolic_calories: int
    ...
    # fractional part of total_descent
    total_fractional_descent: float
    # fractional part of avg_ascent
    avg_fractional_ascent: float
    # fractional part of max_descent
    max_fractional_ascent: float
    avg_grade_adjusted_speed: float
    avg_stress: int
    total_moving_time: float
    start_time: Union[int, datetime]
...
class FitMessages(TypedDict, total=False):
    ...
    battery_mesgs: List[BatteryMesg]
