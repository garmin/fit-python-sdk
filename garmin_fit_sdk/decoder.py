...
class Decoder:
    ...
    def __expand_components(self, mesg_num, message, fields, mesg_def):
        ...
        for field in mesg:
            mesg[field]['raw_field_value'] = util._sanitize_values(mesg[field]['raw_field_value'])
            mesg[field]['field_value'] = util._sanitize_values(mesg[field]['field_value'])
    ...
    def read_file_header(self, reset=True):
        ...
        file_header = FileHeader(self._stream)
